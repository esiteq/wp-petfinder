...
return array(
    ...
    [
            ...
            [
				[
                    ...
                    [
						[
							'type' => 'textbox',
							'name' => 'default_map_height',
							'label' => __('Default Map Height', 'fkcm'),
							'description' => __('If not specified in shortcode', 'fkcm'),
							'default' => '400',
							'validation' => 'numeric',
						],
						[
							...
							'label' => __('Default Map Zoom', 'fkcm'),
							'description' => __('If not specified in shortcode', 'fkcm'),
							'default' => '14',
							'validation' => 'numeric',
						],
						[
							'type' => 'textbox',
							'name' => 'default_radius',
							'label' => __('Default Search Radius', 'fkcm'),
							'description' => __('10 miles if left empty', 'fkcm'),
							'default' => '10',
							'validation' => 'numeric',
						],
                        [
                            'type' => 'textbox',
                            'name' => 'default_map_latlng',
                            'label' => __('Default Map Latitude &amp; Longitude', 'fkcm'),
                            'description' => __('Latitude, Longitude separated with comma', 'fkcm'),
                        ...
                        [
                            ...
                            'label' => __('Locator Default Latitude', 'fkcm'),
                            'description' => __('If no other options specified', 'fkcm'),
                            'default' => '34.052235',
                        ...
                        [
                            ...
                            'label' => __('Locator Default Longitude', 'fkcm'),
                            'description' => __('If no other options specified', 'fkcm'),
                            'default' => '-118.243683',
                            'validation' => 'numeric|required',
                        ],
                        */
						[
                            ...
                            'label' => __('Default Map Type', 'fkcm'),
                            'description' => __('If not specified in shortcode', 'fkcm'),
                            'items' =>
                            [
                                ['value' => 'roadmap', 'label' => __('Roadmap', 'fkcm')],
                                ['value' => 'satellite', 'label' => __('Satellite', 'fkcm')],
                                ['value' => 'hybrid', 'label' => __('Hybrid', 'fkcm')],
                            ],
                            'default' => ['roadmap'],
						],
                        [
                            ...
                            'label' => __('Default Store Marker', 'fkcm'),
                            'description' => __('Used if no category icon was uploaded', 'fkcm'),
                            'default' => str_replace('/inc', '', plugins_url('images/marker.png', __file__)),
                        ],
                        [
                            'type' => 'textbox',
                            'name' => 'default_map_marker_anchor',
                            'label' => __('Store Marker Anchor Point', 'fkcm'),
                            'description' => sprintf(__('Two offsets separated with comma. For details, see the <a href="%s" target="_blank">doc</a>', 'fkcm'), self::DOC_URL),
                            'default' => '15, 31',
                            'validation' => 'twonumbers',
                        ],
                        [
                            'type' => 'upload',
                            'name' => 'default_user_marker',
                            'label' => __('Default User Marker', 'fkcm'),
                            'description' => __('Shows current user position on the map', 'fkcm'),
                            'default' => str_replace('/inc', '', plugins_url('images/user-marker.png', __file__)),
                        ],
                        [
                            'type' => 'textbox',
                            'name' => 'default_user_marker_anchor',
                            'label' => __('User Marker Anchor Point', 'fkcm'),
                            'description' => sprintf(__('Two offsets separated with comma. For details, see the <a href="%s" target="_blank">doc</a>', 'fkcm'), self::DOC_URL),
                            'default' => '15, 31',
                            'validation' => 'twonumbers',
                        ],
                        [
                            'type' => 'radiobutton',
                            'name' => 'fullscreen_maps',
                            'label' => __('Enable Fullscreen Maps?', 'fkcm'),
                            'items' =>
                            [
                                [ 'value' => '1', 'label'=> __('Yes', 'fkcm') ],
                                [ 'value' => '0', 'label'=> __('No', 'fkcm') ],
                            ],
                            'default' => ['1']
                        ],
                        [
                            'type' => 'radiobutton',
                            'name' => 'map_controls',
                            'label' => __('Enable Map Controls?', 'fkcm'),
                            'items' =>
                            [
                                [ 'value' => '1', 'label'=> __('Yes', 'fkcm') ],
                                [ 'value' => '0', 'label'=> __('No', 'fkcm') ],
        ...
        [
            'title' => __('Product Thumbnails', 'wpgp'),
            'icon' =>  'font-awesome:fa-th-large',
        ],
        [
            'title' => __('Product Videos', 'wpgp'),
            'icon' =>  'font-awesome:fa-youtube-play',
        ],
		[
